  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Two-column layout for contact info and image */}
        <div className="grid md:grid-cols-2 gap-8 mb-16">
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1 flex flex-col justify-center space-y-6">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-4 relative group">
                      ...
                      <motion.a
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white py-3 px-4 rounded-lg flex items-center justify-center font-medium shadow-lg transition-all duration-300 text-sm"
                      >
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-4 relative group">
                      ...
                      <motion.a
                        ...
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        className="bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 text-white py-3 px-4 rounded-lg flex items-center justify-center font-medium shadow-lg transition-all duration-300 text-sm"
                      >
                  ...
                  <div className="mt-8">
                    <div className="flex items-center justify-center mb-4">
                      ...
                      <h3 className="text-lg font-bold text-gray-700 dark:text-gray-300 px-4">
                        Connect With Me
                      </h3>
                      <div className="h-px bg-gray-200 dark:bg-gray-700 flex-1" />
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                      {socialLinks.map((social, index) => (
                        ...
                        >
                          <motion.div
                            className={`w-10 h-10 rounded-full bg-gradient-to-br ${social.color} flex items-center justify-center shadow-lg`}
          ...
          >
            <div className="relative max-w-xl">
              {/* Decorative elements */}
              <motion.div
                className="absolute -inset-4 bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 rounded-2xl opacity-30 blur-lg"
                animate={{
                  scale: [1, 1.05, 1],
                  rotate: [0, 1, 0],
                }}
              ...
              {/* Floating shapes */}
              <motion.div
                className="absolute -top-6 -right-6 w-12 h-12 bg-gradient-to-r from-purple-600 to-pink-500 rounded-full opacity-70"
                animate={{
                  y: [0, -15, 0],
                  scale: [1, 1.1, 1],
                }}
              ...
              <motion.div
                className="absolute -bottom-6 -left-6 w-16 h-16 bg-gradient-to-r from-pink-500 to-red-500 rounded-lg opacity-70 rotate-12"
                animate={{
                  y: [0, 15, 0],
                  rotate: [12, 45, 12],
                }}
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    ...
                    >
                      ...
                      <h3 className="text-2xl font-bold">Mirza Nahid</h3>
                    </motion.div>
                  </div>
              ...
              <div className="absolute -z-10 -bottom-8 -right-8 w-24 h-24 opacity-20">
                <div
                  className="absolute inset-0"
                  style={{
                    backgroundImage: `url("data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23d946ef' fillOpacity='0.6'%3E%3Ccircle cx='3' cy='3' r='3'/%3E%3Ccircle cx='13' cy='13' r='3'/%3E%3C/g%3E%3C/svg%3E")`,
          ...
          <Card className="border-0 bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 text-white overflow-hidden relative">
            ...
            <CardContent className="p-12 relative z-10">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center px-10 py-4 bg-white text-pink-600 font-bold text-lg rounded-2xl shadow-2xl hover:shadow-white/25 transition-all duration-300"
              >
