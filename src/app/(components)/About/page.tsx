...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-32 lg:px-28">
        {/* Section Header */}
        <motion.div
        ...
        <motion.div
          ...
          className="pt-4"
        >
          <Card className="border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl shadow-xl group bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 text-white overflow-hidden mt-8">
            <CardContent className="p-8 lg:px-20">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="space-y-2">
                  <h4 className="text-base lg:text-xl font-bold flex items-center">
